        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary"  onClick="javascript:window.location='logins/logout' ;">Logout</button> &nbsp;
              <button type="button" class="btn btn-primary" data-dismiss="modal">Stop Camera</button>
            </div>
          </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
      </div><!-- /.modal -->
