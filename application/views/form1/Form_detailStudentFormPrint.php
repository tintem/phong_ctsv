...
//echo "<pre>";//print_r($datas); 
 foreach ($datas as $key => $data) 
 {
 	 ...
 	 $ngaythangnam = explode('-', $data2['ngaysinh']);
 	 /*echo "<pre>"; print_r($data);
 	 print_r($data2);
 	 print_r($ngaythangnam);
 	  exit;*/
  ?>
...
<div class="group2">
	...
	<div>
		Hiện đang học lớp: <?php echo $data['classid']?>, MSSV: <?php echo $data['studentid'] ?>
	</div>
...
<div class="group3">
	...
	<div class="c4"><?php echo $data2['nguoilamdon'] ?></div>
</div>
