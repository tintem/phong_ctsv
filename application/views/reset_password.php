...
<div class="col-md-4">
	...
	<div class="login-panel panel panel-default">
		...
		<img src="<?php echo base_url('images/logo.png');?>">
			...
			<form method="post" class="form-signin" action="<?php echo site_url('login/reset');?>">
		...
		?>				  
			...
			<div class="form-group">	 
					<label for="inputCode"  >Input code to reset password</label> 
					<input type="text" id="code" name="code" class="form-control" placeholder="Input your code" required >
			</div>
			<div class="form-group">	 
