 ...
 function submit_quiz(){
	 ...
	 $rid=$this->session->userdata('rid');
				...
				if($this->quiz_model->submit_result()){
					...
					$message="<div class='alert alert-success'>".str_replace("{result_url}",site_url('survey/new_survey/'.$rid),"Bạn hãy vui lòng hoàn thành khảo sát để xem kết quả theo link sau <a href='{result_url}'>Khảo sát</a>")."</div>";
